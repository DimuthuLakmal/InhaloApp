...
public class AddControllerMedicineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_controller_medicine);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent saveMedicineDetailsActivity = new Intent(AddControllerMedicineActivity.this, SaveMedicineActivity.class);
                startActivity(saveMedicineDetailsActivity);
            }
        });
    }
}
