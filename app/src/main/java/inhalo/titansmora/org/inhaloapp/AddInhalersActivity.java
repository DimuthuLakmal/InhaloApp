...
//                startActivity(rescueMedicineIntent);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_histroy) {
            ...
            Intent homeIntent = new Intent(AddInhalersActivity.this, HomeActivity.class);
            homeIntent.putExtra("userId", userId);
            startActivity(homeIntent);

        } else if (id == R.id.nav_games) {

            Intent homeIntent = new Intent(AddInhalersActivity.this, GameActivity.class);
            homeIntent.putExtra("userId", userId);
            startActivity(homeIntent);
        } else if (id == R.id.nav_logout) {

            Intent mainActivity = new Intent(AddInhalersActivity.this, MainActivity.class);
